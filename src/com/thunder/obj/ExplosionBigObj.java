...
public class ExplosionBigObj extends GameObj{
    ...
    static {
        for (int i=0;i<explosionImg.length;i++){
            explosionImg[i]=Toolkit.getDefaultToolkit().getImage("res/images/explosionBig"+(i+1)+".png");
        }
    }
    @Override
    ...
    public ExplosionBigObj(double x, double y) {
        super(x, y);
    }
}
