...
public class Plane4Obj extends GameObj{
    int hp=GameWin.plane4Hp;
    @Override
    public Image getImg() {
        return super.getImg();
    }
    ...
    public Plane4Obj(Image img, int width, int height, double x, double y, GameWin frame) {
    ...
    public Plane4Obj(Image img, double x, double y) {
        super(img, x, y);
    }
    ...
    public void paintSelf(Graphics g) {
        ...
        if(GameWin.gameState==2 && GameWin.chosePlane==4) {
            if (GameWin.invincibility[0]==0 || GameWin.invincibility[0]==2) {        //如果不闪烁
                this.x = GameWin.playerX - 40.5;
                this.y = GameWin.playerY - 53;
            }else{
