...
public class Enemy4Obj extends GameObj{
    int hp=30;
    double speed=1;
    @Override
    public Image getImg() {
    ...
    public Enemy4Obj(Image img, int width, int height, double x, double y, GameWin frame) {
        super(img, width, height, x, y, frame);
    }

    public Enemy4Obj(Image img, double x, double y) {
        super(img, x, y);
    }

    public Enemy4Obj(double x, double y) {
        super(x, y);
    }
