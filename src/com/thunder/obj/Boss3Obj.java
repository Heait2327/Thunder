...
public class Boss3Obj extends GameObj{
    ...
    public Boss3Obj(Image img, int width, int height, double x, double y, GameWin frame) {
        super(img, width, height, x, y, frame);
    }

    public Boss3Obj(Image img, double x, double y) {
        super(img, x, y);
    }

    public Boss3Obj(double x, double y) {
        super(x, y);
    }
    ...
    public void paintSelf(Graphics g) {
        ...
        if(GameWin.gameState==2) {
            if(GameWin.bossIfLive==1 && GameWin.bossCome==3){
                hp = 1500;
                x = 253.5-200;
                y = -374;
                GameWin.bossCome=0;
...
/*               g.setColor(Color.white);
                ...
                g.fillRect(gameWidth/2-100,50,hp*200/1500,10);
            }
            if(y<=0) {
                y += speed;
            }
