...
public class ExplosionSmallObj extends GameObj{
    ...
    static {
        for (int i=0;i<explosionImg.length;i++){
            explosionImg[i]=Toolkit.getDefaultToolkit().getImage("res/images/explosionSmall"+(i+1)+".png");
        }
    }
    @Override
    ...
    public ExplosionSmallObj(double x, double y) {
        super(x, y);
    }
}
