...
public class Enemy3Obj extends GameObj{
    int hp=5;
    double speed=1.5;
    @Override
    public Image getImg() {
    ...
    public Enemy3Obj(Image img, int width, int height, double x, double y, GameWin frame) {
        super(img, width, height, x, y, frame);
    }

    public Enemy3Obj(Image img, double x, double y) {
        super(img, x, y);
    }
