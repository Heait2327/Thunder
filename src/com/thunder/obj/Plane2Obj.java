...
public class Plane2Obj extends GameObj{
    int hp=GameWin.plane2Hp;
    @Override
    public Image getImg() {
        return super.getImg();
    }
    ...
    public Plane2Obj(Image img, int width, int height, double x, double y, GameWin frame) {
    ...
    public Plane2Obj(Image img, double x, double y) {
        super(img, x, y);
    }
