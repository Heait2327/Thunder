...
public class Plane1Obj extends GameObj{
    int hp=GameWin.plane1Hp;
    @Override
    public Image getImg() {
        return super.getImg();
    }
    ...
    public Plane1Obj(Image img, int width, int height, double x, double y, GameWin frame) {
        super(img, width, height, x, y, frame);
    }

    public Plane1Obj(Image img, double x, double y) {
        super(img, x, y);
    }
    ...
    public void paintSelf(Graphics g) {
        ...
        if(GameWin.gameState==2 && GameWin.chosePlane==1) {
